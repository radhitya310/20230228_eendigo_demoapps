        ...
        child: Center(
          ...
          children: [
            ...
            Text('Beggining Balance : ' +
                data[0].read.transactionSummary[0].beginningBalance.toString()),
            Text('Credit : ' +
                data[0].read.transactionSummary[0].credit.toString()),
            Text('Credit Freq : ' +
                data[0].read.transactionSummary[0].creditFreq.toString()),
            Text('Debit : ' +
                data[0].read.transactionSummary[0].debit.toString()),
            Text('Debit Freq: ' +
                data[0].read.transactionSummary[0].debitFreq.toString()),
            Text('Ending Balance : ' +
                data[0].read.transactionSummary[0].endingBalance.toString()),
            Text('Period : ' +
                data[0].read.transactionSummary[0].period.toString()),
            Text('warning Mutasi 2 : ' +
                data[0].read.transactionSummary[0].warningMutasi2.toString()),
