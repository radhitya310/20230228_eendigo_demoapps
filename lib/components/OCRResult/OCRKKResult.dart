      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Center(
            ...
            children: [
              Text(
                'alamat : ' + data[0].read.alamat,
              ),
              Text(
                'desa kelurahan : ' + data[0].read.desaKelurahan,
              ),
              Text(
                'kabupaten kota : ' + data[0].read.kabupatenKota,
              ),
              Text(
                'kecamatan : ' + data[0].read.kecamatan,
              ),
              Text(
                'Kode Pos : ' + data[0].read.kodePos,
              ),
              Text(
                'Nama Kepala Keluarga : ' + data[0].read.namaKepalaKeluarga,
              ),
              Text(
                'Nomor Blanko : ' + data[0].read.nomorBlanko,
              ),
              Text(
                'Nomor KK : ' + data[0].read.nomorKk,
              ),
              Text(
                'Provinsi : ' + data[0].read.provinsi,
              ),
              Text(
                'Rt/Rw : ' + data[0].read.rtRw,
              ),
              Padding(
              ...
              Text(
                'alamat : ' + data[0].readConfidence.alamat.toString(),
              ),
              Text(
                'desa kelurahan : ' +
              ...
              Text(
                'Kode Pos : ' + data[0].readConfidence.kodePos.toString(),
              ),
              Text(
              ...
              Text(
                'Nomor KK : ' + data[0].readConfidence.nomorKk.toString(),
              ),
              Text(
                'Provinsi : ' + data[0].readConfidence.provinsi.toString(),
              ),
              Text(
                'Rt/Rw : ' + data[0].readConfidence.rtRw.toString(),
              ),
              Text(
                'Data Keluarga',
              ),
                          ...
                          if (data[0].read.table.isNotEmpty) ...{
                            ...
                            TableRow(children: [
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  data[0].read.table[i].namaLengkap,
                                ),
                              )),
                              TableCell(
                                  child: Padding(
                            ...
                            TableRow(children: [
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  data[0].read.table[i].tanggalLahir,
                                ),
                              )),
                              TableCell(
                                  child: Padding(
                            ...
                            TableRow(children: [
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  data[0].read.table[i].tempatLahir.toString(),
                                ),
                              )),
                              TableCell(
                                  child: Padding(
                            ...
                            TableRow(children: [
                              ...
                              TableCell(
                                ...
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  data[0].read.table[i].noKitasKitap,
                                ),
                              )),
                              TableCell(
                                  child: Padding(
