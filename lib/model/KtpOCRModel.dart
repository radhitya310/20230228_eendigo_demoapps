...
class Ktpocr {
  ...
  factory Ktpocr.fromJson(Map<String, dynamic> json) => Ktpocr(
        ...
        readConfidence: Read2.fromJson(json["read"]),
        status: json["status"],
      );
...
class Read2 {
  ...
  double? agama;
  double? alamat;
  double? berlakuHingga;
  double? golonganDarah;
  double? isEktp;
  double? jenisKelamin;
  double? kecamatan;
  double? kelurahanDesa;
  double? kewarganegaraan;
  double? kotaKabupaten;
  double? nama;
  double? nik;
  double? pekerjaan;
  double? provinsi;
  double? rtRw;
  double? statusPerkawinan;
  double? tanggalLahir;
  double? tempatLahir;
