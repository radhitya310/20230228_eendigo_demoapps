...
InvoiceOcrModel invoiceOcrModelFromJson(String str) => InvoiceOcrModel.fromJson(json.decode(str));

String invoiceOcrModelToJson(InvoiceOcrModel data) => json.encode(data.toJson());
...
class InvoiceOcrModel {
    ...
    factory InvoiceOcrModel.fromJson(Map<String, dynamic> json) => InvoiceOcrModel(
        invoiceInfo: json["Invoice Info"] == null ? [] : List<InvoiceInfo>.from(json["Invoice Info"]!.map((x) => InvoiceInfo.fromJson(x))),
        other: json["Other"] == null ? [] : List<Other>.from(json["Other"]!.map((x) => Other.fromJson(x))),
        payment: json["Payment"] == null ? [] : List<Payment>.from(json["Payment"]!.map((x) => Payment.fromJson(x))),
        receiver: json["Receiver"] == null ? [] : List<InvoiceInfo>.from(json["Receiver"]!.map((x) => InvoiceInfo.fromJson(x))),
        table: json["Table"] == null ? [] : List<Table>.from(json["Table"]!.map((x) => Table.fromJson(x))),
        vendor: json["Vendor"] == null ? [] : List<InvoiceInfo>.from(json["Vendor"]!.map((x) => InvoiceInfo.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "Invoice Info": invoiceInfo == null ? [] : List<dynamic>.from(invoiceInfo!.map((x) => x.toJson())),
        ...
        "Vendor": vendor == null ? [] : List<dynamic>.from(vendor!.map((x) => x.toJson())),
    };
}
...
class InvoiceInfo {
    ...
    factory InvoiceInfo.fromJson(Map<String, dynamic> json) => InvoiceInfo(
        confidenceLabel: json["confidence_label"].toString() == "" ? 0 : json["confidence_label"]?.toDouble(),
        confidenceValue: json["confidence_value"].toString() == "" ? 0 : json["confidence_value"]?.toDouble(),
        label: json["label"],
        value: json["value"],
    );
...
class Payment {
    ...
    factory Payment.fromJson(Map<String, dynamic> json) => Payment(
        page: json["Page"],
        info: json["info"] == null ? [] : List<RowElement>.from(json["info"]!.map((x) => RowElement.fromJson(x))),
    );
...
class RowElement {
    ...
    factory RowElement.fromJson(Map<String, dynamic> json) => RowElement(
        confidenceLabel: json["confidence_label"].toString() == "" ? 0 : json["confidence_label"]?.toDouble(),
        confidenceType: json["confidence_type"].toString() == "" ? 0 : json["confidence_type"]?.toDouble(),
        confidenceValue: json["confidence_value"].toString() == "" ? 0 : json["confidence_value"]?.toDouble(),
        label: json["label"],
        type: json["type"],
        value: json["value"],
...
class Table {
    ...
    factory Table.fromJson(Map<String, dynamic> json) => Table(
        page: json["Page"],
        info: json["info"] == null ? [] : List<TableInfo>.from(json["info"]!.map((x) => TableInfo.fromJson(x))),
    );
...
class TableInfo {
    ...
    factory TableInfo.fromJson(Map<String, dynamic> json) => TableInfo(
        row: json["row"] == null ? [] : List<RowElement>.from(json["row"]!.map((x) => RowElement.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "row": row == null ? [] : List<dynamic>.from(row!.map((x) => x.toJson())),
    };
}
