...
class ReadConfidence {
  ...
  num kecamatan;
  num kodePos;
  num namaKepalaKeluarga;
  num nomorBlanko;
  num nomorKk;
  num provinsi;
  num rtRw;
  List<Table2> table2;
  num tanggalDikeluarkan;
...
class Table2 {
  num agama_confidence;
  num jenisKelamin_confidence;
  num jenisPekerjaan_confidence;
  num kewarganegaraan_confidence;
  num namaAyah_confidence;
  num namaIbu_confidence;
  num namaLengkap_confidence;
  num nik_confidence;
  int no_confidence;
  num noKitasKitap_confidence;
  num noPaspor_confidence;
  num pendidikan_confidence;
  num statusHubunganDalamKeluarga_confidence;
  num statusPerkawinan_confidence;
  num tanggalLahir_confidence;
  num tanggalPerkawinan_confidence;
  num tempatLahir_confidence;
